...
def get_final_report(df, analysis_results):
    ...
    """
    # Extract values from analysis_results [cite: 1]
    ...
    # 1. Top Product Percentage Calculation [cite: 1]
    ...
    # 2. Regional Contribution [cite: 1]
    ...
    # Constructing the concise 'insights' string for the JSON response
    narrative = (
...
if __name__ == "__main__":
    ...
    try:
        ...
        # Perform core analysis [cite: 1]
        results = analyze(df)
        
        # Generate the final report dictionary
        report = get_final_report(df, results)
        
        # ensure_ascii=False ensures the Rupee symbol renders correctly in JSON
